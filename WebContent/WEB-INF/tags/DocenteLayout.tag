...
<c:url value="/docente" var="urlModificarMyUsuario">
    <c:param name="accion" value="modificar-usuario" />
    <c:param name="id-usuario" value="${sessionScope.id_usuario}" />
</c:url>

<div class="wrapper">
    <div class="sidebar" data-color=green data-image="assets/img/sidebar-7.png">
    ...
    <!--   you can change the color of the sidebar using: data-color="blue | azure | green | orange | red | purple" -->
    	...
    	<div class="sidebar-wrapper">
            ...
            <ul class="nav">
            	 <li>
                    <a href='<c:url value="/docente?accion=dashboard" />'>
